...
class AddListCentral extends StatefulWidget {
  const AddListCentral({Key? key}) : super(key: key);

  @override
  State<AddListCentral> createState() => _AddListCentralState();
}

class _AddListCentralState extends State<AddListCentral> {
  File? file;
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child('imgcentral/imgcentral$i.jpg');
