...
class ReviewSouth extends StatefulWidget {
  final DocumentSnapshot south;
  final String? comment;
  final DateTime? datecomment;
  ReviewSouth({required this.south, this.comment, this.datecomment});

  @override
  State<ReviewSouth> createState() => _ReviewSouthState();
}

class _ReviewSouthState extends State<ReviewSouth> {
