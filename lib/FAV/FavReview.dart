...
class FavReview extends StatefulWidget {
  final DocumentSnapshot fav;
  FavReview({Key? key, required this.fav}) : super(key: key);

  @override
  State<FavReview> createState() => _FavReviewState();
}

class _FavReviewState extends State<FavReview> {
  bool isMore = false;
  @override
