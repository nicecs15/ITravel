...
class AddListIsan extends StatefulWidget {
  const AddListIsan({Key? key}) : super(key: key);

  @override
  State<AddListIsan> createState() => _AddListIsanState();
}

class _AddListIsanState extends State<AddListIsan> {
  File? file;
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child('imgisan/imgisan$i.jpg');
