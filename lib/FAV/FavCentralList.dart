...
import 'package:myapp1/FAV/FavCentralDetail.dart';
...
class FavCentralList extends StatefulWidget {
  const FavCentralList({Key? key}) : super(key: key);

  @override
  State<FavCentralList> createState() => _FavCentralListState();
}

class _FavCentralListState extends State<FavCentralList> {
  var inputText = "";
